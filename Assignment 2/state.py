...
class State:
	...
	def __init__(self, max_agent_current_path, min_agent_current_path, vertices_status: dict, max_agent_score: int, min_agent_score: int):
		self.max_agent_current_path = max_agent_current_path
		self.min_agent_current_path = min_agent_current_path
